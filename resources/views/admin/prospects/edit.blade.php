...
<div class="container">
    ...
    <div class="card mt-3">
        <div class="card-body">
            <div class="d-flex">
                <h1>Изменить проспект <small class="text-muted">{{ $prospect->name }}</small></h1>
                <div class="ml-auto">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item" href="{{ route('admin.prospects.dashboard') }}">Просмотр панели управления</a>
                          <a class="dropdown-item" href={{ route('admin.prospects.show', ['prospect' => $prospect->id]) }}>Посмотреть проспект</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item text-danger" href="#" onclick="deleteProspect()">Удалить проспект</a>
    ...
    <div class="row">
        <div class="col-md-4 offset-md-0 col-sm-8 offset-sm-2">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    @endif
                    <hr>
                    <button class="btn btn-outline-primary btn-sm btn-block" data-toggle="modal" data-target="#updateProfileImageModal">Новое изображение профиля</button>
                    @if ($prospect->profile_image)
                        <button class="btn btn-outline-danger btn-sm btn-block" onclick="deleteProfileImage()"><i class="fas fa-trash"></i> Удалить изображение профиля</button>
        ...
        <div class="col-md-8">
            <div class="card mt-3">
                <div class="card-body">
                    <h5>Редактировать личные данные</h5>
                    <hr>
                    @if ($errors->count())
